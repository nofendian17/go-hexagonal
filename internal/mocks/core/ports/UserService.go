...
func (_m *UserService) Create(request *domain.CreateUserRequest) (*domain.Response, error) {
...
func (_m *UserService) Delete(id string) (*domain.Response, error) {
	ret := _m.Called(id)
...
func (_m *UserService) Update(request *domain.UpdateUserRequest) (*domain.Response, error) {
	ret := _m.Called(request)
...
func (_m *UserService) User(id string) (*domain.Response, error) {
	ret := _m.Called(id)
...
func (_m *UserService) Users() (*domain.Response, error) {
	ret := _m.Called()
